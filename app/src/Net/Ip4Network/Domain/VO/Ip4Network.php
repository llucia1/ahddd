...
class Ip4Network extends AggregateRoot
{
    public function __construct(
        private readonly Ip4NetworkUUID               $uuid,
        private readonly Ip4NetworkName               $name,
        private readonly Ip4NetworkNameServer         $nameServer1,
        private readonly Ip4NetworkNameServer         $nameServer2,
        private readonly ?Ip4NetworkNameServer         $nameServer3,
        private readonly ?Ip4NetworkNameServer         $nameServer4,
        private readonly Ip4NetworkPriority           $priority,
        private readonly Ip4NetworkSelectableByClient $selectableByClient,
        private readonly Ip4NetworkFree               $free,
        private readonly Ip4NetworkNetMask            $netmask,
        private readonly Ip4NetworkGateway            $gateway,
        private readonly Ip4NetworkBroadcast          $broadcast,
        private readonly Ip4NetworkNoArp              $noArp,
        private readonly Ip4NetworkRir                $rir,
        private readonly Ip4NetworkActive             $active)
    {
    }
