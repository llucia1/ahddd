...
class E2EGetProxmoxVersionTest extends WebTestCase
{
    ...
    public static function testGetVersionsSuccess(): void
    {
        $response = self::$client->get('/api/v1/proxmox/' . self::$data["proxmox_node_name"] . '/version');
        self::assertEquals(Response::HTTP_OK, $response->getStatusCode());
    } 
    public function testGetProxmoxVersionNotFound(): void
    {
        $response = self::$client->get('/api/v1/proxmox/ns100x/version');
