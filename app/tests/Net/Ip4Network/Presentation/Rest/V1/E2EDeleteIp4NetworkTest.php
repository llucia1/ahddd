...
class E2EDeleteIp4NetworkTest extends WebTestCase
{
     ...
     */
    public static function testDeleteIp4NetworkByUUIDNotExist(): void
    {
        $faker = FakerFactory::create();
        $response = self::$client->request('DELETE','/api/v1/ip4_network/'. $faker->uuid(),['http_errors' => false]);
